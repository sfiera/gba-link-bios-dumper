...
LINK_INLINE auto _MultiBoot(const _MultiBootParam* param,
                                   u32 mbmode) noexcept {
  register union {
...
constexpr int FRAME_LINES = 228;
constexpr int INITIAL_WAIT_MIN_FRAMES = 4;
constexpr int INITIAL_WAIT_MAX_RANDOM_FRAMES = 10;
constexpr int INITIAL_WAIT_MIN_LINES =
    FRAME_LINES * INITIAL_WAIT_MIN_FRAMES;
constexpr int DETECTION_TRIES = 16;
constexpr int MAX_CLIENTS = 3;
constexpr int CLIENT_NO_DATA = 0xFF;
constexpr int CMD_HANDSHAKE = 0x6200;
constexpr int ACK_HANDSHAKE = 0x7200;
constexpr int CMD_CONFIRM_CLIENTS = 0x6100;
constexpr int CMD_SEND_PALETTE = 0x6300;
constexpr int HANDSHAKE_DATA = 0x11;
constexpr int CMD_CONFIRM_HANDSHAKE_DATA = 0x6400;
constexpr int ACK_RESPONSE = 0x7300;
constexpr int ACK_RESPONSE_MASK = 0xFF00;
constexpr int HEADER_SIZE = 0xC0;
constexpr int HEADER_PARTS = HEADER_SIZE / 2;
